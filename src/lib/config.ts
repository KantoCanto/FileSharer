...
export const limits = {
  maxTotalActiveStorageBytes: numberEnv('MAX_TOTAL_ACTIVE_STORAGE_BYTES', 10 * gib),
  softStorageLimitBytes: numberEnv('SOFT_STORAGE_LIMIT_BYTES', 9 * gib),
  maxFileSizeBytes: numberEnv('MAX_FILE_SIZE_BYTES', 2 * gib),
